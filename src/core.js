...
// pure-logic unit tests (core.test.js, run via `npm test`) and the guided
// "load an example graph" first-run feature (App.jsx's loadExample) — the
// app itself never calls these on its own initiative, only in direct
// response to that explicit click.
// ---------------------------------------------------------------------------
